function loadblog(pg){
	switch($('#menuindex').text()){
		case "Blog":
			var menuindex = "blog";
			var add = {title:$("#title").val(),description:$("#description").val(),detail:$("#detail").val(),session:$("#session").val()};
			break;
		case "Content":
			...
			break;
                case "Slide":
			var menuindex = "slide";
			var add = {priority:$("#priority").val(),text:$("#text").val(),session:$("#session").val()};
			break;
                case "User":
			var menuindex = "user";
...
$(document).ready(function() {
	...
	$(document).on("click",".mod",function(){
                ...
                $("#sessionpic").val($(this).parent().children('.attrsession').html());
                if($(this).text()!=='del'){
                    $("#formcontainer").css("display","block");
                    $("#formdelete").css("display","none");
                }else{
